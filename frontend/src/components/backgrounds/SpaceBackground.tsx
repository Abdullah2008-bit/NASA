...
function AnimatedSatellite({ position, color }: { position: [number, number, number], color: string }) {
  ...
  return (
    <group>
      ...
      {/* Glowing aura */}
      <Sphere args={[0.15, 16, 16]} position={meshRef.current?.position.toArray() as [number, number, number]}>
...
export function SpaceBackground() {
  const satellites: Satellite[] = [
    { id: 'TEMPO', position: [3, 2, -5], velocity: [0.01, 0.005, 0], color: '#3b82f6' },
    { id: 'GOES-R', position: [-4, 1, -3], velocity: [-0.01, 0.003, 0], color: '#8b5cf6' },
    { id: 'MERRA-2', position: [2, -2, -6], velocity: [0.008, -0.004, 0], color: '#06b6d4' },
  ]
