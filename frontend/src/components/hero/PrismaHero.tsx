            ...
            <div className="flex items-center justify-between">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-xs text-blue-200/60">NASA Space Apps 2025</div>
                </div>
              </motion.div>
              ...
              >
                {['Features', 'Data Sources', 'Documentation', 'GitHub'].map((item, i) => (
                  <motion.a
                    key={item}
                    href="#"
        ...
        <div className="container mx-auto px-6 pt-32 pb-20">
          <div className="max-w-5xl mx-auto text-center">
            ...
            >
              ...
              <span className="text-white font-semibold">NASA's Earth observation satellites</span>,
            ...
            >
              <div className="text-sm text-white/40 mb-6">POWERED BY NASA EARTH SCIENCE DATA</div>
              <div className="flex flex-wrap items-center justify-center gap-12 opacity-60">
                {['NASA TEMPO', 'MERRA-2', 'GOES-R', 'OpenAQ', 'AWS Cloud'].map((partner) => (
                  <motion.div
                    key={partner}
