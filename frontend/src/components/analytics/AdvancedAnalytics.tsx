...
export function AdvancedAnalytics({ location }: AdvancedAnalyticsProps) {
  const [selectedView, setSelectedView] = useState<
    "anomalies" | "correlations" | "contributions"
  >("anomalies");
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-white/60">
          AI-powered anomaly detection and correlation analysis for{" "}
          {location.name}
        </p>
      </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-white/70">
                  Machine learning algorithms identify unusual air quality
                  patterns that deviate from expected values. Detected{" "}
                  {anomalies.length} anomalies in the last 24 hours.
                </p>
              </div>
            </div>
          </div>
            ...
            >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-white">
                      {anomaly.pollutant} Anomaly Detected
                    </h4>
              ...
              <div className="flex items-center gap-2 mb-3">
                <div className="flex-1 bg-black/30 rounded-full h-2 overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${Math.min(
                        (anomaly.value / anomaly.expected) * 50,
                        100
                      )}%`,
                    }}
                  />
                ...
                <span className="text-sm font-semibold text-white">
                  {((anomaly.value / anomaly.expected - 1) * 100).toFixed(0)}%
                  higher
                </span>
              </div>
              ...
              {anomaly.cause && (
                <div className="flex items-start gap-2 bg-black/20 rounded-lg p-3">
                  <svg
                    className="w-5 h-5 text-white/60 mt-0.5 flex-shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
        ...
        >
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 border border-white/10 rounded-2xl p-6">
            ...
            <p className="text-sm text-white/60 mb-6">
              Correlation coefficients range from -1 (strong negative) to +1
              (strong positive). Values near 0 indicate weak or no correlation.
            </p>
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div
                      ...
                      style={{
                        ...
                        border: `1px solid ${getCorrelationColor(
                          corr.correlation
                        )}40`,
                      }}
                    >
      ...
      {selectedView === "contributions" && (
        ...
        >
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 border border-white/10 rounded-2xl p-6">
            <h3 className="text-lg font-semibold text-white mb-4">
              AQI Contribution by Pollutant
            </h3>
            <p className="text-sm text-white/60 mb-6">
              Each pollutant contributes differently to the overall Air Quality
              Index. This breakdown shows which pollutants are driving poor air
              quality.
            </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-white/70">
                    PM2.5 is the dominant contributor to poor air quality,
                    accounting for {contributions[0].contribution}% of the total
                    AQI. This suggests particulate matter from traffic or
                    wildfires is the primary concern.
                  </p>
                </div>
              </div>
            </div>
