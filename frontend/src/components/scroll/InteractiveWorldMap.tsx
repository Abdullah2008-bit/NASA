...
const GLOBAL_CITIES: Omit<AQIData, "timestamp">[] = [
  // Asia
  { country: "China", city: "Beijing", lat: 39.9042, lon: 116.4074, aqi: 152, pm25: 68.5, no2: 45.2, o3: 32.1, x: 70, y: 35 },
  { country: "China", city: "Shanghai", lat: 31.2304, lon: 121.4737, aqi: 134, pm25: 58.3, no2: 42.1, o3: 28.5, x: 72, y: 40 },
  { country: "India", city: "New Delhi", lat: 28.6139, lon: 77.209, aqi: 189, pm25: 95.2, no2: 62.8, o3: 38.4, x: 60, y: 42 },
  { country: "India", city: "Mumbai", lat: 19.076, lon: 72.8777, aqi: 165, pm25: 78.4, no2: 51.3, o3: 34.2, x: 59, y: 47 },
  { country: "Japan", city: "Tokyo", lat: 35.6762, lon: 139.6503, aqi: 45, pm25: 12.3, no2: 18.5, o3: 42.1, x: 78, y: 37 },
  { country: "South Korea", city: "Seoul", lat: 37.5665, lon: 126.978, aqi: 72, pm25: 28.5, no2: 32.4, o3: 38.2, x: 73, y: 36 },
  { country: "Thailand", city: "Bangkok", lat: 13.7563, lon: 100.5018, aqi: 98, pm25: 42.1, no2: 35.6, o3: 31.8, x: 67, y: 50 },
  { country: "Singapore", city: "Singapore", lat: 1.3521, lon: 103.8198, aqi: 52, pm25: 18.2, no2: 22.4, o3: 35.1, x: 68, y: 55 },
  
  // Europe
  { country: "UK", city: "London", lat: 51.5074, lon: -0.1278, aqi: 58, pm25: 21.3, no2: 28.5, o3: 36.2, x: 45, y: 25 },
  { country: "France", city: "Paris", lat: 48.8566, lon: 2.3522, aqi: 62, pm25: 24.1, no2: 31.2, o3: 34.5, x: 46, y: 27 },
  { country: "Germany", city: "Berlin", lat: 52.52, lon: 13.405, aqi: 48, pm25: 16.5, no2: 24.3, o3: 38.1, x: 48, y: 25 },
  { country: "Italy", city: "Rome", lat: 41.9028, lon: 12.4964, aqi: 65, pm25: 26.8, no2: 33.1, o3: 32.8, x: 48, y: 31 },
  { country: "Spain", city: "Madrid", lat: 40.4168, lon: -3.7038, aqi: 54, pm25: 19.2, no2: 26.5, o3: 37.4, x: 43, y: 32 },
  
  // Americas
  { country: "USA", city: "New York", lat: 40.7128, lon: -74.006, aqi: 68, pm25: 28.2, no2: 35.1, o3: 42.5, x: 20, y: 32 },
  { country: "USA", city: "Los Angeles", lat: 34.0522, lon: -118.2437, aqi: 85, pm25: 38.5, no2: 41.2, o3: 52.3, x: 12, y: 36 },
  { country: "USA", city: "Chicago", lat: 41.8781, lon: -87.6298, aqi: 55, pm25: 21.5, no2: 28.4, o3: 38.2, x: 18, y: 30 },
  { country: "Canada", city: "Toronto", lat: 43.6532, lon: -79.3832, aqi: 42, pm25: 14.2, no2: 22.1, o3: 36.5, x: 19, y: 28 },
  { country: "Mexico", city: "Mexico City", lat: 19.4326, lon: -99.1332, aqi: 112, pm25: 48.5, no2: 45.3, o3: 48.2, x: 15, y: 46 },
  { country: "Brazil", city: "São Paulo", lat: -23.5505, lon: -46.6333, aqi: 72, pm25: 31.2, no2: 36.8, o3: 35.1, x: 27, y: 65 },
  { country: "Argentina", city: "Buenos Aires", lat: -34.6037, lon: -58.3816, aqi: 58, pm25: 22.4, no2: 28.5, o3: 34.2, x: 25, y: 72 },
  
  // Oceania
  { country: "Australia", city: "Sydney", lat: -33.8688, lon: 151.2093, aqi: 38, pm25: 11.2, no2: 18.5, o3: 38.2, x: 82, y: 72 },
  { country: "Australia", city: "Melbourne", lat: -37.8136, lon: 144.9631, aqi: 42, pm25: 14.5, no2: 21.2, o3: 36.8, x: 80, y: 74 },
  
  // Africa
  { country: "South Africa", city: "Johannesburg", lat: -26.2041, lon: 28.0473, aqi: 78, pm25: 32.5, no2: 38.2, o3: 31.5, x: 50, y: 68 },
  { country: "Egypt", city: "Cairo", lat: 30.0444, lon: 31.2357, aqi: 142, pm25: 65.3, no2: 52.1, o3: 35.8, x: 51, y: 40 },
  { country: "Kenya", city: "Nairobi", lat: -1.2921, lon: 36.8219, aqi: 88, pm25: 38.2, no2: 35.5, o3: 32.1, x: 53, y: 56 },
  
  // Middle East
  { country: "UAE", city: "Dubai", lat: 25.2048, lon: 55.2708, aqi: 95, pm25: 42.8, no2: 38.5, o3: 45.2, x: 56, y: 43 },
  { country: "Saudi Arabia", city: "Riyadh", lat: 24.7136, lon: 46.6753, aqi: 118, pm25: 52.3, no2: 42.1, o3: 38.5, x: 54, y: 43 },
  { country: "Turkey", city: "Istanbul", lat: 41.0082, lon: 28.9784, aqi: 82, pm25: 35.2, no2: 38.8, o3: 34.2, x: 50, y: 31 },
];
...
export default function InteractiveWorldMap() {
  ...
  const [liveData, setLiveData] = useState<AQIData[]>(
    GLOBAL_CITIES.map(city => ({ ...city, timestamp: new Date().toISOString() }))
  );
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setLiveData((prevData) =>
        prevData.map((city) => ({
          ...city,
          aqi: Math.max(20, Math.min(300, city.aqi + Math.floor(Math.random() * 10 - 5))),
            ...
            >
              {filteredCities.length === 0 ? (
                <span className="text-orange-400">
                  ⚠️ No data available for "{searchQuery}". Try another location!
                </span>
              ) : (
                <span>
                  ✅ Found {filteredCities.length} location{filteredCities.length !== 1 ? 's' : ''}
                </span>
              )}
            </motion.div>
          )}
            ...
            >
              ...
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">
                <div className="bg-black/90 backdrop-blur-md px-3 py-2 rounded-lg border border-white/20">
                  ...
                  <div className="text-xs" style={{ color: getAQIColor(city.aqi) }}>
                    AQI: {city.aqi}
                  </div>
                </div>
              </div>
          ...
          >
            <div className="bg-black/80 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl">
              ...
              <div className="mt-4 text-xs text-gray-500 text-center">
                Last updated: {new Date(selectedCity.timestamp).toLocaleTimeString()}
              </div>
            </div>
          </motion.div>
        )}
